...
def test_default_test_window_does_not_overwrite_real_application_size(qtbot, tmp_path):
    settings = QSettings(str(tmp_path / "real-application.ini"), QSettings.Format.IniFormat)
    try:
